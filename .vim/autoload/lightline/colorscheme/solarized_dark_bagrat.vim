...
" Author: itchyny (updated by bagrat)
" License: MIT License
...
let s:p.normal.right = [ [ [ s:base02[0], '214' ] , [ s:base0[0], '10' ] ], [ s:base1, [ s:base01[0], '239' ] ] ]
" let s:p.normal.right = [ [ s:base02, s:base0 ], [ s:base1, s:base01 ] ]
let s:p.normal.middle = [ [ s:base1, s:base02 ] ]
let s:p.inactive.right = [ [ s:base02, s:base01 ], [ ['#000000', '8'], ['#000000', '10'] ] ]
let s:p.inactive.left =  [ [ ['#000000', '8'], ['#000000', '10'] ] ]
let s:p.inactive.middle = [ [ ['#000000', '0'], ['#000000', '10'] ] ]
...
let g:lightline#colorscheme#solarized_dark_bagrat#palette = lightline#colorscheme#flatten(s:p)
